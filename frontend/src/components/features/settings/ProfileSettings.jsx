  ...
  return (
    <div className="flex flex-col h-full">
      ...
      <div className="px-8 py-6 border-b border-gray-100 bg-white sticky top-0 z-10">
        ...
        <p className="text-sm text-gray-500 mt-1">Update display information and avatar</p>
      </div>
        ...
        <form onSubmit={handleSubmit} className="max-w-2xl space-y-8">
          ...
          <div className="flex flex-col sm:flex-row items-center gap-6 pb-6 border-b border-gray-100">
            ...
            <div className="text-center sm:text-left">
              ...
              <p className="text-sm text-gray-500 mt-1 mb-3">Supports JPG, GIF, or PNG files.</p>
              <button type="button" onClick={() => fileInputRef.current.click()} className="text-sm font-semibold text-pink-600 hover:text-pink-700 hover:underline">
                Upload New
              </button>
            </div>
          </div>
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full pl-10 pr-4 py-2.5 border border-gray-300 rounded-xl focus:ring-2 focus:ring-pink-500/20 focus:border-pink-500 outline-none transition"
          ...
          <div className="pt-4">
            <button
              ...
              className="flex items-center justify-center gap-2 px-6 py-2.5 bg-pink-500 text-white font-medium rounded-xl hover:bg-pink-600 disabled:opacity-70 disabled:cursor-not-allowed transition shadow-sm w-full sm:w-auto ml-auto"
            >
